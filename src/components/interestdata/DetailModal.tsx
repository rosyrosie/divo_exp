...
import { modalQtyColumns, modalRankColumns } from "@utils/tableUtil";
      ...
      <div className="modal_flex">
        <div className="modal_rank_box">
          ...
          <div className="table_box">
            <Table columns={modalRankColumns} dataSource={modalData?.data} size="middle" loading={mLoading} bordered />
          </div>
        </div>
        <div className="modal_qty_box">
          ...
          <div className="table_box">
            <Table columns={modalQtyColumns} dataSource={searchQty?.data} size="middle" loading={sLoading} bordered />
          </div>
        </div>
      </div>
    </Modal>
